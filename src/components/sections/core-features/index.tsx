      ...
      <div className="max-w-[72rem] mx-auto">
        <div className="mb-12 text-center">
          <h2 className="mb-3 font-bold text-gray-800 text-3xl dark:text-white/90 md:text-title-lg max-w-xl mx-auto">
            AI services that make capability visible
          </h2>

          <p className="max-w-xl mx-auto leading-6 text-gray-500 dark:text-gray-400">
            Reforward builds conversational AI experiences that help people
            understand, demonstrate, and develop what they can do in the real
            world.
          </p>
        </div>
